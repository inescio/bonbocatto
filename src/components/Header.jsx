      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            <MobileNavItem href="/products">Productos</MobileNavItem>
            <MobileNavItem href="/about">Empresa</MobileNavItem>
            <MobileNavItem href="/contact">Contacto</MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
      ...
      <Link
        ...
        className={clsx(
          ...
          isActive
            ...
            : 'hover:text-yellow-500 dark:hover:text-yellow-400',  // <-- Aquí cambia de color en hover
        )}
      >
        {children}
        {isActive && (
    ...
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        <NavItem href="/">Inicio</NavItem>
            ...
            <NavItem href="/about">Empresa</NavItem>
...
function Avatar({ large = false, className, ...props }) {
  const { resolvedTheme } = useTheme()  // <-- Detectamos el tema actual
  const selectedAvatar = resolvedTheme === 'dark' ? avatarImageDark : avatarImageLight
  ...
  return (
    ...
    >
      <Image
        src={selectedAvatar}  // <-- Elegimos el logo en función del tema
        alt=""
